...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='order',
            name='ptao',
            field=models.ForeignKey(blank=True, to='inventory.PTAO', null=True, on_delete=models.CASCADE),
        ),
        migrations.AddField(
            model_name='item',
            name='manufacturer',
            field=models.ForeignKey(help_text='leave blank if unknown or same as vendor', blank=True, to='inventory.Manufacturer', null=True, on_delete=models.CASCADE),
        ),
        migrations.AddField(
            model_name='item',
            name='parent_item',
            field=models.ForeignKey(help_text='example: for printer cartriges, select printer', blank=True, to='inventory.Item', null=True, on_delete=models.CASCADE),
        ),
        migrations.AddField(
            model_name='item',
            name='unit',
